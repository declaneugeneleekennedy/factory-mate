# FactoryMate
[![CircleCI](https://circleci.com/gh/declaneugeneleekennedy/factory-mate.svg?style=svg)](https://circleci.com/gh/declaneugeneleekennedy/factory-mate) [![codecov](https://codecov.io/gh/declaneugeneleekennedy/factory-mate/branch/master/graph/badge.svg)](https://codecov.io/gh/declaneugeneleekennedy/factory-mate)

FactoryMate is a PHP implementation of [FactoryBot](https://github.com/thoughtbot/factory_bot). It was originally
intended as an enhancement to [FactoryMuffin](https://github.com/thephpleague/factory-muffin), but ultimately needed API
changes which would cause a lot of headaches for existing users. As such, it's now offered as an alternative for new
projects.

<div style="text-align:center;">
    <a href="https://github.com/cutenode/1x.engineer/stargazers">
